...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["confirm-confirm-module"], {
  ...
  function srcAppConfirmConfirmModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _confirm_routing_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./confirm-routing.module */
    "./src/app/confirm/confirm-routing.module.ts");
    /* harmony import */


    var _confirm_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./confirm.page */
    "./src/app/confirm/confirm.page.ts");
    /* harmony import */
  ...
  function srcAppConfirmConfirmPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function ConfirmPage(location, route, menu) {
      ...
      _createClass(ConfirmPage, [{
        ...
        value: function Next() {
          if (this.ConfirmForm.valid) {
            localStorage.setItem('firstName', "".concat(this.ConfirmForm.value.firstName));
            localStorage.setItem('lastName', "".concat(this.ConfirmForm.value.lastName));
            localStorage.setItem('phoneNumber', "".concat(this.ConfirmForm.value.phoneNumber));
            localStorage.setItem('address1', "".concat(this.ConfirmForm.value.address1));
            localStorage.setItem('address2', "".concat(this.ConfirmForm.value.address2));
            localStorage.setItem('city', "".concat(this.ConfirmForm.value.city));
            localStorage.setItem('State', "".concat(this.ConfirmForm.value.State));
            localStorage.setItem('street', "".concat(this.ConfirmForm.value.street));
            localStorage.setItem('zipCode', "".concat(this.ConfirmForm.value.zipCode));
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common__WEBPACK_IMPORTED_MODULE_3__["Location"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"], _ionic_angular__WEBPACK_IMPORTED_MODULE_5__["MenuController"]])], ConfirmPage);
    /***/
  }
}]);
