...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["payment-payment-module"], {
  ...
  function srcAppPaymentPaymentPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function PaymentPage(location, modalService, route) {
        ...
        value: function Pay() {
          ...
          if (this.ConfirmForm.valid) {
            ...
            setTimeout(function () {
              ...
              _this.route.navigateByUrl('/categories');
            }, 5000);
          }
        }
      }, {
        key: "openModal",
        value: function openModal(template, credit, val) {
          var _this2 = this;

          if (val == 'Cash') {
            setTimeout(function () {
              _this2.modalRef = _this2.modalService.show(template);
            }, 1000);
            setTimeout(function () {
              _this2.modalRef.hide();

              _this2.route.navigateByUrl('/categories');
            }, 6000);
          } else {
            setTimeout(function () {
              _this2.modalRef = _this2.modalService.show(credit);
            }, 1000);
          }
        }
      }]);
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('template', {
      static: true
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Object)], PaymentPage.prototype, "temp", void 0);
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common__WEBPACK_IMPORTED_MODULE_2__["Location"], ngx_bootstrap_modal__WEBPACK_IMPORTED_MODULE_3__["BsModalService"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"]])], PaymentPage);
    /***/
  }
}]);
