...
/* harmony import */ var _must_match__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../must-match */ "./src/app/must-match.ts");
...
let ProfilePage = class ProfilePage {
    constructor(modalService, fb, camera, base64) {
    ...
    changePhoto() {
        ...
        this.camera.getPicture(options).then(imageData => {
            ...
            this.base64.encodeFile(this.imageURI).then((base64File) => {
                this.imgURL = base64File.replace("data:image/*;charset=utf-8;base64,", "data:image/png;base64,");
                this.userPhoto = "";
                this.isEdit = true;
            });
        }, err => {
...
], ProfilePage.prototype, "temp", void 0);
